Locales['en'] = {
  ...
  ['mobile_repair_tools']           = 'Mobile Repair Tools',
  ['blowtorch']                 = 'blowtorch',
  ...
  ['vehicle_spawner'] = 'Press ~INPUT_CONTEXT~ to open Vehicle menu',
  ...
  ['confirm_no'] = 'no',
  ['confirm_yes'] = 'yes',
  ['helicopter_prompt'] = 'Press ~INPUT_CONTEXT~ to open Helicopter Menu',
}
